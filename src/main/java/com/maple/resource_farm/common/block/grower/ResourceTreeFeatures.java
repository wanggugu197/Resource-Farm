package com.maple.resource_farm.common.block.grower;
...
import static com.maple.resource_farm.data.ResourceFarmBlocks.ResourceTreeMap;
...
public class ResourceTreeFeatures {
    ...
    public static final ResourceTreeConfiguration.ResourceTreeConfigurationBuilder CHERRY = new ResourceTreeConfiguration.ResourceTreeConfigurationBuilder(
            ...
            new CherryTrunkPlacer(7, 1, 0,
                    new WeightedListInt(WeightedList.<IntProvider>of(
                            new Weighted<>(ConstantInt.of(1), 1),
                            new Weighted<>(ConstantInt.of(2), 1),
