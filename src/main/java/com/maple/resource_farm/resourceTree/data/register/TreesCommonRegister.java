...
public class TreesCommonRegister {
     ...
     * TreeRecipe.TreeSaplingRecipeBuild(consumer, "wood", Items.OAK_LOG, Items.BIRCH_LOG, Items.APPLE,
     * Items.MOSS_BLOCK);
     * 
     * TreeRecipe.TreeItemRecipeBuild(consumer, "dyes",
     * item(Items.WHITE_DYE, 32), item(Items.ORANGE_DYE, 32), item(Items.MAGENTA_DYE, 32), item(Items.LIGHT_BLUE_DYE,
     * 32),
     ...
     * TreeRecipe.TreeItemRecipeBuild(consumer, "amethyst_shard", item(Items.BUDDING_AMETHYST, 1),
     * item(Items.AMETHYST_CLUSTER, 1));
     * }
     * 
     ...
     * TreeRecipe.TreeItemRecipeBuildWithExtra(consumer, "honeycomb", Items.GLASS_BOTTLE, 4, item(Items.HONEY_BOTTLE,
     * 4));
     ...
     * TreeRecipe.TreeSaplingRecipeBuild(consumer, "minor_creature", Items.ROTTEN_FLESH, Items.GUNPOWDER, Items.BONE,
     * Items.SPIDER_EYE);
     * }
     * 
     ...
     * TreeRecipe.TreeItemAndSaplingRecipeBuild(consumer, "berries", item(Items.SWEET_BERRIES, 16),
     * item(Items.GLOW_BERRIES, 16));
     * TreeRecipe.TreeItemAndSaplingRecipeBuild(consumer, "prismarine", item(Items.PRISMARINE_CRYSTALS, 16),
     * item(Items.PRISMARINE_SHARD, 16));
