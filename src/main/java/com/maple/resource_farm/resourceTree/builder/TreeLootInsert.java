...
public class TreeLootInsert {
    ...
    private static void setBlockDrops(BlockEntry<?> blockEntry, ResourceLocation lootTableId) {
     ...
     */
    public static void generateBlockLoot(BiConsumer<ResourceLocation, LootTable> lootTables,
