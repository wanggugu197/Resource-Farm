...
public class ResourceFarmConfigHolder {
    ...
    public static class DeveloperConfigs {
        ...
        @Configurable.Comment({
                "是否导出所有已注册的数据？ 默认值: false",
                "Dump all registered data? Default: false"
        })
        public boolean dumpData = false;

        @Configurable
        @Configurable.Comment({
                "是否导出所有已注册的资源？ 默认值: false",
                "Dump all registered assets? Default: false"
        })
    ...
    public static class TreeConfigs {
        ...
        @Configurable.Comment({
                "树木方块生成相关配置",
                "Configuration for tree block generation"
        })
        ...
        @Configurable.Comment({
                "树木配方生成相关配置",
                "Configuration for tree recipe generation"
        })
    ...
    public static class BlockGenerationConfigs {
        ...
        @Configurable.Comment({
                "是否生成去皮原木方块？ 默认值: true",
                "Whether to generate Stripped Log blocks? Default: true"
        })
        public boolean generateStrippedLog = true;

        @Configurable
        @Configurable.Comment({
                "是否生成木材（竖原木）方块？ 默认值: true",
                "Whether to generate Wood blocks? Default: true"
        })
        ...
        @Configurable.Comment({
                "是否生成去皮木材方块？ 默认值: true",
                "Whether to generate Stripped Wood blocks? Default: true"
        })
        ...
        @Configurable.Comment({
                "是否生成木板方块？ 默认值: true",
                "Whether to generate Planks blocks? Default: true"
        })
    ...
    public static class RecipeGenerationConfigs {
        ...
        @Configurable
        @Configurable.Comment({
                "是否生成树木物品合成配方？ 默认值: true",
                "Whether to generate TreeItem craft recipes? Default: true"
        })
        ...
        @Configurable.Comment({
                "是否生成树苗合成配方？ 默认值: true",
                "Whether to generate Sapling craft recipes? Default: true"
        })
        public boolean generateSaplingRecipes = true;

        @Configurable
        @Configurable.Comment({
                "是否生成树脂熔炼/烟熏获取配方？ 默认值: true",
                "Whether to generate Resin smelting/smoking recipes? Default: true"
        })
        public boolean generateResinRecipes = true;

        @Configurable
        @Configurable.Comment({
                "是否生成基础木材转换配方（原木/木材/木板转换）？ 默认值: true",
                "Whether to generate basic wood conversion recipes (log/wood/planks)? Default: true"
        })
